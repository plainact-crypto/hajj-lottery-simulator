...
var onRequestPost = /* @__PURE__ */ __name(async (context) => {
  ...
  const current = await context.env.DB.prepare("SELECT attempt_count FROM leads WHERE email = ?").bind(email).first();
...
// ../.wrangler/tmp/pages-xJyI7O/functionsRoutes-0.016496013679616395.mjs
var routes = [
  {
...
// ../../../../../../Users/mohamed.osama/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../../../Users/mohamed.osama/AppData/Local/npm-cache/_npx/32026684e21afda6/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
